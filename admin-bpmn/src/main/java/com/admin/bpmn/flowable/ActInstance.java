package com.admin.bpmn.flowable;
...
public interface ActInstance {
   ...
   * @return
   */
  Map<String, TaskVO> startInstanceAndExecuteFirstTask(String processDefinitionKey, String tenantId, String userId, Map<String, Object> variables);

...
public class JobInvokeUtil {
   ...
   * @param sysJob 系统任务
   */
  public static void invokeMethod(SysScheduleJobEntity sysJob) throws Exception {
   ...
   * 获取method方法参数相关列表
   *
   * @param methodStr 参数字符串
   * @return method方法相关参数列表
   */
  public static List<Object[]> getMethodParams(String methodStr) {
    ...
    for (String methodParam : methodParams) {
      ...
      else if ("true".equals(str) || StringUtils.equalsIgnoreCase(str, "false")) {

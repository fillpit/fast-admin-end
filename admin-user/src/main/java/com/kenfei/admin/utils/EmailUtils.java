package com.kenfei.admin.utils;

import com.kenfei.admin.core.utils.HttpUtils;
...
/**
 * 邮件发送工具
 * 参考： https://juejin.cn/post/6850418118699778055
 * @author fei
...
public class EmailUtils {
  ...
  @Value("${spring.mail.username:xxx@qq.com}")
